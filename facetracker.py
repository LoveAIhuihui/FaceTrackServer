...
##循环
    ...
    while True:
        ...
        if first:
            ...
            #     out = cv2.VideoWriter(args.video_out, cv2.VideoWriter_fourcc('F','F','V','1'), args.video_fps, (width * args.video_scalee, height * args.video_scale))
        ...
        try:
            ...
            if detected and len(faces) < 40:
                print("发送UDP")
                # sock.sendto(packet, (addr, target_port))
